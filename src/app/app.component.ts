...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, MoviedataComponent, MovieListComponent],
...
export class AppComponent {
  movies = [
    ...
    },
    {
      ...
      name: 'PS2',
      poster:
        'https://m.media-amazon.com/images/M/MV5BMmYxZmY4MDItMTYyZC00OGRlLWExY2QtMmQ0OThkNTNmNzJkXkEyXkFqcGdeQXVyMTUyNjIwMDEw._V1_.jpg',
      summary:
